...
local function random_action()
    ...
    if CHAT_NOTIFY then sampAddChatMessage("[AntiAFK_Action] Aksi acak dijalankan.", 0xAAAAFF) end
end

function stop()
    ENABLED = false
    sampAddChatMessage("[AntiAFK_Action] Dinonaktifkan oleh Loader.", 0xFF3333)
end
